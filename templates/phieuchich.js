...
function luutaisan() {
	...
	//if (t6=='0')	{	alert('bạn chưa chọn người nhận tài sản !!!'); document.getElementById('nguoinhants').focus(); return ;	}

	//====================================================================

	k0 = (document.getElementById('loainhom').value);
	k1 = (document.getElementById('ngay').value);
	k2 = (document.getElementById('sochungtu').value);
	k3 = (document.getElementById('sotien').value);
	k4 = (document.getElementById('lydo').value);
	k5 = (document.getElementById('nguoinhan').value);
	k6 = (document.getElementById('nguoichi').value);
	k7 = (document.getElementById('cuahang').value);
	k8 = (document.getElementById('donvi').value);
	if (k0 == '-1') k8 = document.getElementById('nhacungcap').value;
	k9 = (document.getElementById('note').value);
	k10 = (document.getElementById('ID').value);
	k11 = document.getElementById('luachon').value;
	k12 = document.getElementById('loaitaikhoan').value;
	k13 = document.getElementById('nganhang').value;
	k14 = document.getElementById('loaitaisan').value;



	//	if (t11==''){	alert('bạn chưa chọn loại thu chi mua bán !!!'); document.getElementById('luachon').focus(); return ;	}
	if (k1 == '') { alert('bạn chưa chọn ngày chứng từ !!!'); document.getElementById('ngay').focus(); return; }
	if (k12 == '1' && k13 == '') { alert('bạn chưa chọn ngân hàng !!!'); document.getElementById('nganhang').focus(); return; }
	if (k13 != '' && k12 == '0' && t0 != '1') { alert('bạn phải chọn loại tài khoản là tiền mặt nếu ô này có chọn tài khoản ngân hàng !!!'); document.getElementById('loaitaikhoan').focus(); return; }

	if (k2 == '') { alert('bạn chưa nhập số chứng từ !!!'); document.getElementById('sochungtu').focus(); return; }
	if (k0 == '') { alert('bạn chưa chọn nhóm thu chi mua bán !!!'); document.getElementById('loainhom').focus(); return; }
	if (k7 == '0') { alert('bạn chưa chọn cửa hàng !!!'); document.getElementById('cuahang').focus(); return; }
	if (k0 == '-1' && k8 == '0') { alert('bạn chưa chọn nhà cung cấp !!!'); document.getElementById('nhacungcap').focus(); return; }
	if (k4 == '') { alert('bạn chưa nhập lý do !!!'); document.getElementById('lydo').focus(); return; }
	if (k3 == '') { alert('bạn chưa nhập số tiền !!!'); document.getElementById('sotien').focus(); return; }
	if (k13 == '' && k12 == '0' && k0 == '1') { alert('bạn phải chọn  tài khoản ngân hàng !!!'); document.getElementById('nganhang').focus(); return; }
	if (k14 == '0') { alert('bạn phải chọn tài sản là CÓ hoặc KHÔNG !'); document.getElementById('loaitaisan').focus(); return; }


	// poststr = "DATA=" + encodeURIComponent(k0) + "*@!" + encodeURIComponent(k1) + "*@!" + encodeURIComponent(k2) + "*@!" + encodeURIComponent(k3);
	// poststr = poststr + "*@!" + encodeURIComponent(k4) + "*@!" + encodeURIComponent(k5) + "*@!" + encodeURIComponent(k6) + "*@!" + encodeURIComponent(k7);
	// poststr = poststr + "*@!" + encodeURIComponent(k8) + "*@!" + encodeURIComponent(k9) + "*@!" + encodeURIComponent(k10) + "*@!" + encodeURIComponent(k11);
	// poststr = poststr + "*@!" + encodeURIComponent(k12) + "*@!" + encodeURIComponent(k13) + "*@!" + encodeURIComponent(k14) + "*@!" + encodeURIComponent(0);
	...
	poststr = poststr + "*@!" + encodeURIComponent(t12) + "*@!" + encodeURIComponent(nhom) + "*@!" + encodeURIComponent(k0) + "*@!" + encodeURIComponent(k1)+ "*@!" + encodeURIComponent(k2) + "*@!" + encodeURIComponent(k3)+ "*@!" + encodeURIComponent(k4) + "*@!" + encodeURIComponent(k5)+ "*@!" + encodeURIComponent(k6) + "*@!" + encodeURIComponent(k7) + "*@!" + encodeURIComponent(k8)+ "*@!" + encodeURIComponent(k9) + "*@!" + encodeURIComponent(k10)+ "*@!" + encodeURIComponent(k11) + "*@!" + encodeURIComponent(k12) + "*@!" + encodeURIComponent(k13)+ "*@!" + encodeURIComponent(k14) + "*@!" + encodeURIComponent(0);
	console.log(poststr);
	loadtrang('ketqualuu', "thuchich_luutaisan", poststr, "xuly2");
}
...
document.getElementById('search2').click();
var so = document.getElementById('luachon').value();