...
<fieldset  class="nencon">
 ...
 <!-- BEGIN: block_cusht1 -->
			...
			<b style="display:none" >	[<a href="?act=themnghiviec&id=-1">Thêm Mới</a>]</b>&nbsp;&nbsp;&nbsp;[<a href="?act=md">Đóng Lại</a>] &nbsp;
...
<div>
    ...
    <tr bgcolor="#F8E4CB">
	  ...
	  <td width="114" align="center"><strong>Tên NV </strong></td>
	   ...
	   <td width="150" align="center"><strong>ngày làm việc tổng</strong></td> 
	   
		<td width="228" align="center"><strong>Lý do giám sát</strong></td> 
...
<td ><strong>{tennhanvien}</strong> <br /> {chucvu} </td>
 ...
 <td style="    max-width: 200px;
    word-break: break-word;">{tongngaylam}</td> 
