...
//lương văn phòng
function luongVP($luongvitri, $luongnangluc, $phucap, $congchuanthang, $congthucte, $sotienbaohiem, $daung, $phat)
{
...
// ASM
function luongDoanhThu($luongcoban, $luongdoanhthu, $phucap, $congchuanthang, $congthucte, $sotienbaohiem, $daung, $phat)
{
