...
<fieldset  class="nencon">
	...
	<label style="Color:#FF3300;Font-Weight:Bold;Font-size:11pt;" >Phiếu Pass đơn</label>
	</a> </legend>
...
<div style="padding-top:24px;font-size:16px;padding-bottom:10px" > 
      ...
      <input class="chucnang" type="button" name="themmoi"  id="themmoi" style="width:75px;display:{q_them}"  onclick="window.open('default.php?act=passdon','_self')" value="Thêm Mới" />
...
<script language="javascript" src="templates/passdon.js" > </script>