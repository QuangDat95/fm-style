...
if ($loaiphieu != 13 && $loaiphieu != 14) {
	...
	$where__="from phieubanhangluu b
		...
		where (b.LyDo>45 and b.lydo not in (53,56,57,69,79)) and ((b.Loai in (1,3,5) and b.dakhoa = 1 and idchOL <> -1)  
		and (b.NgayNhap >= $tungay_ and b.NgayNhap <= $denngay_)) and d.loai<>22  
 $whereNV  group by b.IDTao,b.diachiN,b.idchol";
 
 	$where__dondi="from phieubanhangluu b
		left join vanchuyenonline d on b.ID = d.IDbill
		 where ((b.LyDo>45 and b.lydo not in (53,56,57,69,79) and b.Loai in (1,3,5) and b.dakhoa = 1  and idchOL <> -1) and d.loai<>22  and (b.NgayNhap >= $tungay_ and b.NgayNhap <= $denngay_))   $whereNV  group by b.ID,b.IDTao,b.diachiN,b.idchol";
	...
	$where1__="from phieubanhangluu b left join vanchuyenonline d on b.ID=d.IDbill where (b.LyDo>45 and b.lydo not in (53,56,57,69,79))	and d.loai<>22  and b.Loai =3 and b.dakhoa = 1 and b.NgayNhap >= $tungay_ and b.NgayNhap <= $denngay_  and b.idchOL = 0 and b.idchOL  <>-1  $whereNV  and SUBSTRING_INDEX(SoCT,'TL',1) in (select SoCT from phieubanhangluu where ngaynhap>=$tungay_ and ngaynhap<=$denngay_) group by b.IDTao,b.diachiN,b.idchol";
...
sum(case when (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)  
and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ then (ceil(b.DonGia*(1-1*b.chietkhau/100))*b.SoLuong) else 0 end) as tongdt, 

sum(b.SoLuong) as tongsl,
count(DISTINCT case when (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ then  b.id end ) as sb,
/*========== So luong di ==========*/ 
sum(case when(b.loai=1) and (b.idchOL = 0 or b.diachiN=b.idgioithieu) then 1 else 0 end) as soluongdi, 
/*========== Doanh Thu SP < 30K và không đồng giá ==========*/
sum(case when(b.DonGia<30000)
	and b.IDtao = b.DonGia /*Không đồng giá*/
	and (b.idchOL = 0)  and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_  
	and (b.Tigia = 10 or b.Tigia <= 0 ) then (ceil(b.DonGia*(1-1*b.chietkhau/100))*b.SoLuong)
	else 0 end) as dtpmduoi30, 
sum(case when(b.DonGia<30000) and b.IDtao = b.DonGia /*Không đồng giá*/
	and (b.Tigia = 10 or b.Tigia <= 0)
	and (b.idchOL = 0)   and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ 
	then b.SoLuong else 0 end) as tongsoluongpmduoi30,
sum(case when(b.DonGia<30000) and b.IDtao = b.DonGia /*Không đồng giá*/
	and (b.idchOL <> 0)   and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_  /*DT Pass*/
	and (b.Tigia = 10 or b.Tigia <= 0)
...
sum(case when(b.DonGia >= 30000 and b.DonGia <100000)
	and (b.idchOL = 0)   and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ 
	and (b.Tigia = 10 or b.Tigia <= 0)
...
sum(case when(b.DonGia >= 30000
	and b.DonGia <100000) and (b.idchOL <> 0)   and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_  /*DT Pass*/
	and (b.Tigia = 10 or b.Tigia <= 0)
	then b.SoLuong else 0 end) as tongdonpasstu30den100,
/*=========== Doanh Thu SP >= 100K và < 180K ================*/
sum(case when(b.DonGia >= 100000 and b.DonGia <180000)
	and (b.idchOL = 0)  and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ 
	and (b.Tigia = 10 or b.Tigia <= 0)
...
sum(case when(b.DonGia >= 180000)
	and (b.idchOL = 0) and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu) 
...
sum(case when(b.DonGia >= 180000) and (b.idchOL = 0)   
	and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   
	and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ 
	and (b.Tigia = 10 or b.Tigia <= 0)
	then b.SoLuong else 0 end) as tongsoluongpmtu180,
sum(case when(b.DonGia >= 180000) and (b.idchOL <> 0)   
	and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   
	and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_  /*DT Pass*/
	and (b.Tigia = 10 or b.Tigia <= 0) 
...
sum(case when (((b.TiGia > 0 AND b.TiGia <> 10) or (b.IDtao <> b.DonGia and b.DonGia<30000 )) )
	and (b.idchOL = 0) and b.IDtao <> b.DonGia   
	and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu) 
	and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_  
...
sum(case when (((b.TiGia > 0 AND b.TiGia <> 10) or (b.IDtao <> b.DonGia and b.DonGia<30000 )) )
	and (b.idchOL = 0)   and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   
	and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_  
	then b.SoLuong else 0 end) as tongdonspctkhuyenmai,
...
sum(case when (((b.TiGia > 0 AND b.TiGia <> 10) or (b.IDtao <> b.DonGia and b.DonGia<30000 )) )
	and (b.idchOL <> 0)   and (d.dongthoigiantrangthaidon = 1 or b.diachiN=b.idgioithieu)   
	and d.ngayhoanthanh>=$hoanthanhtungay_ and d.ngayhoanthanh<=$hoanthanhdendenngay_ 
	then b.SoLuong else 0 end) as tongdonspctkhuyenmaipass
$where__ ";
