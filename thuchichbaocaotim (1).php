...
//===========================================================================
		...
		$sql = "SELECT a.*,b.Ten,DATE_FORMAT(a.ngaythuchi,'%d/%m/%y') as ngay,DATE_FORMAT(a.ngaykhoa,'%d/%m/%y') as ngaykhoa,DATE_FORMAT(a.ngaytao,'%d/%m/%y') as ngaytao FROM thuchich a left join userac b on a.IDtao = b.ID left join cuahang c on a.loaitk=c.id where 1=1 ".$sql_where." ORDER BY a.ngaytao desc  ";
		//echo $sql ;
...
if($_SESSION["admintuan"])  echo $sql  ;
  // return ;
	...
	$sql2 = "SELECT  sum(case when  a.luachon = 1 then a.sotien else -(a.sotien) end )as tong,DATE_FORMAT(a.ngaykhoa,'%d/%m/%Y') as ngaykhoa FROM thuchich a left join userac b on a.IDtao = b.ID  left join cuahang c on a.loaitk=c.id 
...
<div   style="display:auto;overflow:scroll;width:1050px;height:385px"  >
 ...
 <table width="99%" border="0" cellpadding="0" cellspacing="0" class="tbchuan">		
				    <tr bgcolor="#F8E4CB">
				      ...
				      <td width="64" align="center" title="Ngày chứng từ"><strong onclick="sapxep('<?php echo $s1 ;?>')" style="cursor:pointer">Ngày CT</strong></td>  
					   <td width="64" align="center" title="Ngày chứng từ"><strong onclick="sapxep('<?php echo $s1 ;?>')" style="cursor:pointer">Ngày tạo</strong></td>  
