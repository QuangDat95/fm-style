...
$data->access();
 ...
 FROM thuchikt a left join dinhkhoanthuchi d on a.IDcha=d.ID left join cuahang b on a.loaitk=b.id left join tinh c on c.ID=b.Fax where 1=1 ".$sql_where." and b.IDNhomcc <> 8 and (d.ma='NTTKQ' or d.ma='NTMVQ') group by a.ngaythuchi,a.loaitk order by  a.ngaythuchi desc";
 ...
 FROM thuchikt a left join dinhkhoanthuchi d on a.IDcha=d.ID left join cuahang b on a.loaitk=b.id left join tinh c on c.ID=b.Fax where 1=1  ".$sql_where." and b.IDNhomcc <> 8 and (d.ma='NTTKQ' or d.ma='NTMVQ') group by a.ngaythuchi,a.loaitk order by  a.ngaythuchi desc limit $start,$limit";
//var_dump($sql);
