		 ...
		 //   echo $data1 ;
		  ...
		  $phuong  = trim($tmp[3])  ;
		   ...
		   $makh=  (trim($tmp[5]))   ;
			...
			$sql="update customer set address='$diachi',IDKhuVuc='$IDKhuVuc',quan='$quan',phuong='$phuong',note='$note',ngaycapnhap='$ngaytao' where makh='$makh'";
		...
		<tr>
			<td width="17%"><div align="right">Tỉnh Thành &nbsp;</div></td>
			  ...
			  <select class="js-phuong" name="phuong" id="phuong" style="width:170px" onchange="checkchangevalue()">
				  <option value="0"> </option>
				 	<?php
				  	 	echo composxConcat("phuong","CONCAT(loai,' ',Name)","name",$re['phuong']," where idtinh='$re[IDKhuVuc]' and _district_id='$re[quan]'"); 
				   ?>
