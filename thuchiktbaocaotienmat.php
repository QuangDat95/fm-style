...
$data->access();
 ...
 //  $mangtk = taomang ("dinhkhoan","ID","madinhkhoan");
  ...
  // var_dump($mangtk);
	  ...
	  $sql_rows = "SELECT  DATE_FORMAT(a.ngaythuchi,'%d/%m/%Y') as ngaythuchikt,sum(round(a.psco))as tongpsco,sum(round(a.psno))as tongpsno,a.loaitk,b.Name,b.macuahang as tencuahang,a.ngaythuchi FROM thuchikt a left join dinhkhoanthuchi c on a.IDcha=c.ID left join cuahang b on a.loaitk=b.id  
	where 1=1  ".$sql_where." and (c.ma <> 'TL' and c.ma <> 'TLDK') group by a.ngaythuchi,a.loaitk ORDER BY a.ngaythuchi,b.ID desc";
	...
	where 1=1 ".$sql_where." and (c.ma <> 'TL' and c.ma <> 'TLDK') group by a.ngaythuchi,a.loaitk ORDER BY a.ngaythuchi,b.ID desc limit $start,$limit";
