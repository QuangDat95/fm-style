...
<div style="padding:5px"> 
				<b style="display:{q_them}">[ <a href="default.php?act=nhomcongvan&id=-1">Thêm Mới</a>]</b>
[<a href="default.php?act=md">Đóng Lại</a>]</div>
 ...
 <td width="66" align="center"style='border:solid windowtext 1.0pt; mso-border-alt:solid windowtext .5pt;padding:0in 0.4pt 0in 0.4pt'><strong>Mã </strong></td>
      <td width="1027" align="center"style='border:solid windowtext 1.0pt; mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'><strong>Tên Công Văn </strong></td>	  
...
function kttrung(kt){
     ...
     kiemtratrung(document.getElementById('loai').value,'tbnhomcongvantk','ma',kt,'Trùng mã nhóm Phụ tùng !!!','Có lỗi trên đường truyền !!!',"ma");
