...
<form name="frmProduct1" id="frmProduct1" method="post">
	<div class="nenbao">
		<fieldset class="nencon">
			...
			<b style="display:{q_them}"> [<a href="default.php?act=phieuxuly&id=-1">Thêm
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbchuan">
				...
				<tr bgcolor="#F8E4CB">
					...
					<td width="79" align="center"><strong>Tên NV </strong></td>
				...
				<tr bgcolor="{color}">
					...
					<td>{lydo} </td>
					<td>{tinhtrang} </td>
					<td align="center"> <a href="default.php?act=phieuxuly&id={ID}"><img src="images/book_addressHS.png"
								border="0"></a> </td>

					<td align="center"
						style="border:solid windowtext 1.0pt;display:{q_xoa}; mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt">
						<a onclick='return ask()' href="default.php?act=phieuxuly&Del={XOA}"><img
			...
			<table width="100%" border="0" cellpadding="5">
				...
				<tr class=" " id="">
					<td width="14%" id="capnhatphieu">Mã nhân viên </td>
					<td width="86%">
						<input type="Text" name="manv" id="manv" class="text" size="15" value="{manv}"
							onchange="kiemtraphieuthuchi(loaicapnhat.value,manv.value,ngay.value)" />
					</td>
				</tr>
				<tr class=" " id="">
					<td width="14%" id="capnhatphieu">Ngày</td>
					<td width="86%">
						<input type="date" name="ngay" id="ngay" class="text" size="15" value="{ngay}"
							onchange="kiemtraphieuthuchi(loaicapnhat.value,manv.value,ngay.value)" />
					</td>
				</tr>
...
<script language="JavaScript">
	...
	location.replace("default.php?act=phieuxuly");
</script>
<!-- END: block_cusupdate -->
...
<script language="JavaScript">
	...
	function kiemtraphieuthuchi(t1, t2, t3) {


		if (t1 == '' || t2 == '') return;
		poststr = "DATA=" + encodeURIComponent(t1) + "*@!" + encodeURIComponent(t2) + "*@!";

		loadtrang('show_kq', "phieuxulykiemtra", poststr, "xuly2");
	}
