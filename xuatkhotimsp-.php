...
$data->access();
  ...
  $tmp = explode('*@!',$data1);
	...
	//	$sql = "SELECT * FROM products  ".$sql_where." ORDER BY NgayTao desc  ";
		$sql = " SELECT a.ID,a.Name,a.NameN, b.SoLuong,  a.NameEN,a.codepro,a.code,a.price ,c.giagiam ,a.giachan,a.giamgia,c.giamgia as giam ";
...
// $dvt = $re['DV'] ;
  if ($gia =='0.00') $gia = "";
	 ...
	 ?>
 	 	<tr title="<?php echo $re['note'] ?>"   style="cursor:pointer" onclick="setsanpham('<?php echo $re['ID'] ;?>','<?php echo $ten ;?>','<?php echo $ma ;?>','<?php echo $gia ;?>','<?php echo $dvt ;?>','<?php echo $giamgia ;?>','<?php echo $giachan ;?>','<?php echo $re['SoLuong'] ;?>','<?php echo $re['NameN'] ;?>','<?php echo $re['giadagiam'] ;?>')" onMouseOver="this.className='<?php echo $hl2; ?>'" onMouseOut="this.className='<?php echo $hl; ?>'"  bgcolor="<?php echo $mau; ?>" >
...
?>	
 ...
 ?>
  ...
  {
  	 echo "<font size=2  color='#FF3300'>Không tìm thấy hàng hóa nào, bạn có thể tìm theo từ ngắn hơn hoặc bấm vào nút '<b>Thêm hàng hóa</b>' để thêm hàng hóa !!!</font> " ;
  }
