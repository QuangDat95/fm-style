...
<fieldset  class="nencon" style="padding:5;margin:0">
	...
	<label style="Color:#FF3300;Font-Weight:Bold;Font-size:9pt;" >Phạt vi phạm</label>
	</a></legend>
	 
<!-- BEGIN: block_khht1 --><form name="frmProduct1"  id="frmProduct1"  method="post" style="padding:0;margin:0">
	<table width="100%" border="0" cellpadding="0" class="tbchuan" cellspacing="0">		
 		<tr>
			<td colspan = "8">
				[ <a href="?act=phat&id=-1">Thêm Mới</a>]&nbsp;&nbsp;[<a href="?act=md">Đóng Lại</a>]&nbsp;&nbsp;Tên 
...
<td width="76"  align="center"><strong>Ngày ứng</strong></td>	  
 <td width="286"  align="center"><strong>Tên Nhân viên</strong></td>
  <td width="76"  align="center"><strong>Mã NV</strong></td>     
  <td width="506"  align="center"><strong>Lý Do Phạt</strong></td>
...
<!-- BEGIN: block_khht -->	
				...
				<td align="center"  > 
				<a href = "?act=phat&id={ID}"> <img src = "images/book_addressHS.png" border = "0" ></a> </td>


				<td  align="center">  <a onclick='return ask()' href="?act=phat&Del={ID}"><img src="images/delete.gif" border = "0"></a></td>								
				</tr>
<!-- End: block_khht -->	

<!-- BEGIN: block_khht2 -->	
<tr style="padding-top:10"><td align="right" colspan="5"><strong>Tổng cộng :</strong></td><td> <strong>{tongphat}</strong></td><td></td><td></td> </tr>
...
<form name="frmkho" id="frmkho" method="post" style="width:470px">
...
<tr>
	<td >Ngày Phạt</td>
	<td > 
	  <input onkeypress="return chuyentiep(event,'denngay')" ondblclick="this.value=''" type="text" name="ngay"   id="ngay" class="text" style="width:70px"  value="{ngay}" />
<img src="images/img.gif" id="Lichtphataytao" style="cursor: pointer; border: 0px solid red;" title="Date selector"  onclick="displayCalendar(frmkho.ngay,'dd/mm/yyyy',this)" /> </td>
</tr>
<tr>
	<td colspan="2">
		<input type="Submit" class="text" name="btnUpdate" onclick="return kiemtra()"  value="Cập nhập"> <input type="button" onclick="nhay('phat')" class="text" name="cancel" value="Quay Lại" />	</td>
</tr>
</table>	
</form>
</div>
...
Tìm nhân viên
 <input type="Text" ID="tentim" name="tentim" class="text" size="20" value="{tentim}" /> 
 Mã NV
 <input type="Text" ID="codetim" name="codetim" class="text" size="10" value="{codetim}" />
 ...
 function kiemtra()
{
  ...
  if (trim(document.getElementById('ngay').value) =='')
	{
