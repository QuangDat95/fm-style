...
<fieldset  class="nencon"  > 
	...
	<label style="Color:#FF3300;Font-Weight:Bold;Font-size:9pt;" >Duyệt phiếu đề xuất</label></a>
    </legend>
...
<script language="JavaScript">
 ...
 function showchitiet(id){
 	...
 	poststr="DATA="+    encodeURIComponent(id)+  "*@!"+ encodeURIComponent(0)
	  loadtrang('poupduyet', "duyetdexuaform", poststr,"xuly4") ;
 }
...
function timphieu(t1,t2,t3,t4,t5,t6,t7,t8,t9)
{
  ...
  if(t7==1)  loadtrang('httim', "duyetdexuatgoptim", poststr,"") ;
  else       loadtrang('httim', "duyetdexuattim", poststr,"") ;
 ...
 var cf = " Bạn có chắc chắn muốn duyệt phiếu cho nhân viên "+tennv+" này hay không ? " ;
 	if(thongbao(cf) == false) { 
    	...
    	poststr="DATAC="+   encodeURIComponent(tc)+  "*@!"+encodeURIComponent(idlogin)+  "*@!"+ encodeURIComponent(loai)+ "*@!"+ encodeURIComponent(lydo)+  "*@!"+ encodeURIComponent(0);
     	loadtrang('khonghienthi',"dexuatduyetduyet",poststr,"xuly1") ;	
	}	
}
...
function goiduyet(id,idl,tennv,loai,vl,el) {
	 	...
	 	if(vl==4)
		{
		    ...
		    {	showloading1(); 
				...
				loadtrang('khonghienthi',"duyetdexuatduyet",poststr,"xuly1") ;	
			}	
		}
		else 
		{
