...
if ($loaiusertim != 0)	$sql_where .= " and  b.ChucVu ='" . $loaiusertim . "'";
...
if ($thang != '') {
	...
	// echo  $thang.'==='.$ngaycuoi ;
	$thangtinhluong =	explode("-", $thang)[1];
...
//==================mang thong tin luong ============================================				
$sql3 = "select * from  ns_luongthang";
$result = $data->query($sql3);
$mangthongtinluong = [];
while ($rec = $data->fetch_array($result)) {
	$mangthongtinluong[$rec['IDNV']] = array(
		'luongcoban' => (int) $rec['luongcoban'],
		"luongkpi" => (int) $rec['luongkpi'] ? $rec['luongkpi'] : $rec['luongds'],
		"phat" => (int) $rec['phat'],
		"daung" => (int) $rec['daung'],
		"phucap" => (int) $rec['phucap'],
		"bhxh" => (int) $rec['bhxh'],
		"ngaychuan" => $rec['ngaychuan'],
		"songaytrongthang" => $rec['songaytrongthang'],
		"socuahang" => $rec['socuahang'],
		"luongtrachnhiem" => $rec['luongtrachnhiem'],
		"luongkpimien" => $rec['luongkpimien'],
		"luongkpidoanhthu" => $rec['luongkpidoanhthu'],
		"chucvu" => $rec['chucvu'],
		"phongban" => $rec['phongban']
	);
}
// echo "<pre>";
// var_dump($mangthongtinluong);
// echo "</pre>";
//in($manglamthem);
//==============================================================		
	...
	<table width="99%" border="0" cellpadding="0" cellspacing="0" class="tbchuan">
		<thead>
			<tr bgcolor="#F8E4CB">
				...
				<th width="74" align="center"><strong>Lương cơ bản chuẩn</strong></td>
				<th width="74" align="center"><strong>Lương cơ bản</strong></td>
				<th width="74" align="center"><strong>Tỉ lệ HTDT</strong></td>
				<th width="74" align="center"><strong>Hệ số Luong DT</strong></td>
				<th width="74" align="center"><strong>Lương KPI</strong></td>
				<th width="74" align="center"><strong>Phần trăm doanh thu</strong></td>
				<th width="74" align="center"><strong>Hệ số Luong DT</strong></td>
				<th width="74" align="center"><strong>Tổng ngày trong tháng</strong></td>
				<th width="74" align="center"><strong>Số ngày mở cửa</strong></td>
				<th width="74" align="center"><strong>Lương trách nhiệm thực</strong></td>
				<th width="74" align="center"><strong>Lương doanh thu</strong></td>
				<th width="74" align="center"><strong>Lương chỉ tiêu</strong></td>

				<th width="74" align="center"><strong>Lương ứng</strong></td>
				<th width="74" align="center"><strong>Lương thực lãnh</strong></td>
	 	...
	 	in($idnv);
			...
			?>
				<tr title="<?php echo addslashes($re['note']); ?>" onclick="setkh('<?php echo addslashes($re["idkhach"]); ?>','<?php echo addslashes($re['Name']); ?>','<?php echo $re['address']; ?>','<?php echo $re['tel']; ?>')" onMouseOver="this.className='<?php echo $hl2; ?>'" onMouseOut="this.className='<?php echo $hl; ?>'" bgcolor="<?php echo $mau; ?>">
					...
					?>
						<!--  <td align="center" bgcolor="<?= $maugiolam; ?>" title="<?= $title ?>">
				 <?= $giolam; ?> 
				 <br /><span style="font-size:10px"><?= $giochunhat ?></span></td>-->
					<?php  } ?>
					<?php $sogio =  floor($giotinhluong / 60);
					$sophut = $giotinhluong % 60;
					$tangca = $manglamthem[$idnv];
					if ($tangca) {
						$giotc =  floor($tangca / 60);
						$tangca  = $tangca - $giotc * 60;
					...
					// echo $idnv;
					$luongcobanchuan = $mangthongtinluong[$idnv]["luongcoban"];
					$luongkpi = $mangthongtinluong[$idnv]["luongkpi"] ? $mangthongtinluong[$idnv]["luongkpi"] : 0;

					$luongkpidoanhthu = $mangthongtinluong[$idnv]["luongkpidoanhthu"];
					$socuahang = $mangthongtinluong[$idnv]["socuahang"];
					$luongtrachnhiemchuan = $mangthongtinluong[$idnv]["luongtrachnhiem"];
					$luongkpimien = $mangthongtinluong[$idnv]["luongkpimien"];
					$tongngaythang = cal_days_in_month(CAL_GREGORIAN, $thangtinhluong, $namtinhluong);
					$ngaythem = $tongngay - 26;
					$lp = luongphut($luongcobanchuan);
					$luongcoban = $lp * $giotinhluong;
					//echo number_format($lp);
					
					if ($idch == 62 && $chucvugoc != 977 && $chucvugoc != 872 && $chucvugoc != 763 && $chucvugoc != 740 && $chucvugoc != 876 && $chucvugoc != 742 && $chucvugoc != 779) {
						
						//văn phòng
						if ($mangthongtinluong[$idnv]["luongcoban"]) {

							$luongtinh = luongVP($mangthongtinluong[$idnv]["luongcoban"], $mangthongtinluong[$idnv]["luongkpi"], $mangthongtinluong[$idnv]["phucap"],$tongngaythang,$tongngay, $mangthongtinluong[$idnv]["bhxh"],$mangthongtinluong[$idnv]["daung"],$mangthongtinluong[$idnv]["phat"]);
							$luongthuclanh = $luongtinh;
							$luongung = $mangthongtinluong[$idnv]["daung"];
						}
					} else {
						if ($mangthongtinluong[$idnv]["luongcoban"]) {

							$luongtinh = luongDoanhThu($mangthongtinluong[$idnv]["luongcoban"], $mangthongtinluong[$idnv]["luongkpi"], $mangthongtinluong[$idnv]["phucap"],$tongngaythang,$tongngay, $mangthongtinluong[$idnv]["bhxh"],$mangthongtinluong[$idnv]["daung"],$mangthongtinluong[$idnv]["phat"]);
							$luongthuclanh = $luongtinh;
							$luongung = $mangthongtinluong[$idnv]["daung"];
							// echo $luongung;
						}
						...
						// 		if ($mangthongtinluong[$idnv]["luongcoban"]) {
						// 			$luongtinh = luongQuanLyVungMien($luongcoban, $socuahang, $doanhthumuctieu, $doanhthutatcacuahang, $songaymocua, $luongtrachnhiemchuan, $hanghoa, $nhansudaotao, $doanhthumoicuahang, $dichvu, $luongkpimien, $thangtinhluong, $namtinhluong);
						// 			$phantramdoanhthu = $luongtinh["phantramdt"];
						// 			$tongngaythang = $luongtinh["tongngaythang"];
						// 			$luongtrachnhiem = $luongtinh["luongtrachnhiem"];
						// 			$hesoluongdt = $luongtinh["hesoluong"];
						// 			$luongdoanhthu = $luongtinh["luongdoanhthumien"];
						// 			$luongthuclanh = $luongtinh["luong"];

						// 			if ($chucvugoc == 861) {
						// 				$luongthuclanh = $luongthuclanh * 0.85;
						// 			}
						// 		}
						// 		break;
						// 	case 4:
						...
						// 			$cocuahangpho = true;
						// 			$loai = 1;
						// 			$luongtinh = luongCHTCHP($luongcoban, $doanhthudoichieu, $doanhthumuctieu, $doanhthuthuc, $doanhthudat, $giatricotloi, $cocuahangpho, $luongkpi, $loai);
						// 			//var_dump($luongtinh);
						// 			$phantramdoanhthu = $luongtinh["phantramdt"];
						// 			$luongkpi = $luongtinh["luongkpithuc"];
						// 			$hesoluongdt = $luongtinh["hesodt"];
						// 			$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			//var_dump($luongthuclanh);
						// 			if ($chucvugoc == 683) {
						// 				$luongthuclanh = $luongthuclanh * 0.85;
						// 			}
						// 		}
						...
						// 			$luongtinh =  luongCVTV($luongcoban, $doanhthucanhan);
						// 			$hesoluongdt = $luongtinh["heso"];
						// 			$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			//var_dump($luongthuclanh);
						// 			if ($chucvugoc == 848 || $chucvugoc == 849 || $chucvugoc == 850) {
						// 				$luongthuclanh = $luongthuclanh * 0.85;
						// 			}
						// 		}
						// 		break;
						...
						// 			$luongtinh =  luongCVTN($luongcoban, $doanhthucalamviec, $hesodoanhthu, $doanhthucanhan);
						// 			$hesoluongdt = $luongtinh["heso"];
						// 			$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			//var_dump($luongthuclanh);
						...
						// 			$hesodoanhthu = 0.2;
						// 			$luongtinh =  luongTDKH($luongcoban, $doanhthucalamviec, $hesodoanhthu, $luongkpi);
						// 			$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			//var_dump($luongthuclanh);
						// 			if ($chucvugoc == 851 || $chucvugoc == 852 || $chucvugoc == 853) {
						// 				$luongthuclanh = $luongthuclanh * 0.85;
						// 			}
						// 		}
						// 		break;
						// 		//chuyên vien sale online
						// 	case 688:
						// 	case 689:
						// 	case 738:
						// 	case 765:
						...
						// 			//$luongcoban=4000000;
						// 			$doanhthucanhan = 100000000;
						// 			$loai = 1; //1=chính thức 2=thử việc
						// 			if ($chucvugoc == 765 || $chucvugoc == 766 || $chucvugoc == 767) {
						// 				$loai = 2;
						// 				$doanhthucanhan = 70000000;
						// 			}
						// 			$luongtinh = luongCVSaleOnline($luongcoban, $doanhthucanhan, $loai);
						// 			$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			$hesoluongdt = $luongtinh["hesodt"];
						// 			//var_dump($luongthuclanh);
						...
						// 			$luongtinh = luongtruongphongsale($luongcoban, $doanhthudoichieu, $luongkpi, $doanhthudexuat, $chiphiquangcao, $doanhthuthuc, $chiphiquangcaothuc, $nvsale, $nvsaletv);
						// 			$luongkpi = $luongtinh["luongkpi"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			$luongchitieu = $luongtinh["luongchitieu"];
						// 			//var_dump($luongthuclanh);
						// 			if ($chucvugoc == 873) {
						// 				$luongthuclanh = $luongthuclanh * 0.85;
						// 			}
						...
						// 			$luongtinh = luongphoteamonline($luongcoban, $doanhthudexuat, $chiphiquangcao, $chiphiquangcaothuc, $doanhthuthuc, $nvsale, $nvsaletv, true);
						// 			$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 			$luongthuclanh = $luongtinh["luong"];
						// 			$luongchitieu = $luongtinh["luongchitieu"];
						// 			//var_dump($luongthuclanh);
						...
						// 		//$luongkpi=8000000;
						// 		$luongtinh = luongchuyenviencontent($luongcoban, $doanhthudexuat, $doanhthuthuc);
						// 		$luongthuclanh = $luongtinh["luong"];
						// 		$luongkpi = $luongtinh["luongkpi"];
						// 		//var_dump($luongthuclanh);
						// 		if ($chucvugoc == 774) {
						...
						// 		$chiphi = 1000000000;
						// 		$luongtinh = luongtruongphongtmdt($luongcoban, $doanhthudexuat, $doanhthuthuc, $doanhthudoichieu, $luongkpi, $chiphi);
						// 		$luongthuclanh = $luongtinh["luong"];
						// 		$luongkpi = $luongtinh["luongkpi"];
						// 		$luongchitieu = $luongtinh["luongchitieu"];
						// 		//var_dump($luongthuclanh);
						...
						// 		$doanhthudoichieu = 3000000000;
						// 		$chiphi = 1000000000;
						// 		$luongtinh = luongchuyenvientmdt($luongcoban, $doanhthudexuat, $doanhthuthuc, $doanhthudoichieu, $luongkpi, $chiphi);
						// 		$luongthuclanh = $luongtinh["luong"];

						// 		$luongchitieu = $luongtinh["mucluongchitieu"];
						// 		//var_dump($luongthuclanh);
						// 		if ($chucvugoc == 783 || $chucvugoc == 784) {
						// 			$luongthuclanh = $luongthuclanh * 0.85;
						// 		}
						// 		break;
						...
						// 		$soluongnv = 6;
						// 		$loaicv = 1;
						// 		$luongtinh = luongtruongphongquangcao($luongcoban, $doanhthudexuat, $doanhthuthuc, $doanhthudoichieu, $luongkpi, $chiphi, $loaicv, $luongtrachnhiemchuan, $soluongtp, $soluongtn, $soluongnv);
						// 		$luongthuclanh = $luongtinh["luong"];
						// 		$tilehoanthanhdoanhthu = $luongtinh["tilehoanthanhdt"];
						// 		$luongchitieu = $luongtinh["mucluongchitieu"];
						// 		//var_dump($luongthuclanh);
						// 		if ($chucvugoc == 877) {
						// 			$luongthuclanh = $luongthuclanh * 0.85;
						...
						// 		$tilehoanthanhdoanhthu = $luongtinh["tilehoanthanhdt"];
						// 		$luongchitieu = $luongtinh["mucluongchitieu"];
						// 		$luongtrachnhiem = $luongtinh["luongtrachhiem"];
						// 		//var_dump($luongthuclanh);
						// 		if ($chucvugoc == 878) {
						// 			$luongthuclanh = $luongthuclanh * 0.85;
						// 		}
						...
						// 		$luongtinh = luongtruongphonglivestream($luongcoban, $doanhthuhethong, $luongkpi);
						// 		$luongthuclanh = $luongtinh["luong"];
						// 		$luongdoanhthu = $luongtinh["luongdoanhthu"];
						// 		$luongkpi = $luongtinh["luongkpi"];
						// 		//var_dump($luongthuclanh);
					...
					?>
					<td align="center"><?php echo number_format($luongcobanchuan); ?></td>
					<td align="center"><?php echo number_format($luongcoban); ?></td>
					<td align="center"><?php echo number_format($tilehoanthanhdoanhthu) . "%"; ?></td>
					<td align="center"><?php echo number_format($hesoluongkpidoanhthu); ?></td>
					<td align="center"><?php echo number_format($luongkpi); ?></td>

					<td align="center"><?php echo number_format($phantramdoanhthu) . "%"; ?></td>
					<td align="center"><?php echo $hesoluongdt; ?></td>
					<td align="center"><?php echo number_format($tongngaythang); ?></td>
					<td align="center"><?php echo number_format($songaymocua); ?></td>
					<td align="center"><?php echo number_format($luongtrachnhiem); ?></td>
					<td align="center"><?php echo number_format($luongdoanhthu); ?></td>
					<td align="center"><?php echo number_format($luongchitieu); ?></td>

					<td align="center"> <?php echo number_format($luongung); ?></td>
					<td align="center"><?php echo number_format($luongthuclanh); ?></td>
