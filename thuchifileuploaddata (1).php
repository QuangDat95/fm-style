...
$idkho =$_SESSION["se_kho"];
	...
	if ($us == "") exit ;
	//$thumuc = substr($us,0,strpos($us,"_",1)) .'t';
	//$ngay = substr($us,strpos($us,"_",1)+1,strlen($us)) ;
	//$dir   = getcwd()."/file/$thumuc"  ;
	...
	$dungluongCH='2000000';
	$filesize=$dungluongCH; 
	if($idkho==1105){
		$dungluongCH='10000000';
		$filesize=$dungluongCH;
	}
  ...
  { 
 	   ...
 	   $msg = "Vượt dung lượng cho phép $dungluongCH !!!" ;	
//	   echo $msg  ;
  	 //   $msg="" .($kt)  ;
		//return() ;
		echo "{";
 ...
 // 	if ( !preg_match('/^[a-z0-9\_\-][a-z0-9\_\-\. ]*$/i', $_FILES['fileToUpload']['name']))
//	{
//		$error = 'Tên file không dùng ký tự đặt biệt !!!' ;//'zei';
//		echo "{";
//		echo				"error: '" . $error . "',\n";
//		echo				"msg: '" . $msg . "'\n";
//		echo "}" ; 
