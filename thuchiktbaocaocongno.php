...
$chuoiCN=rtrim($chuoiCN,",");
	  ...
	  $sql_rows = "SELECT DATE_FORMAT(a.ngaythuchi,'%m/%d/%Y') as ngaythuchikt,b.macuahang as tencuahang,c.manv as MaNV,c.Ten as tennhanvien,a.note,a.tkno,a.tkco,a.psno,a.psco,d.ma as madk
 FROM thuchikt a left join dinhkhoanthuchi d on a.IDcha=d.ID left join cuahang b on a.loaitk=b.id  left join userac c on a.manv= c.MaNV where 1=1 ".$sql_where." and d.ma in ($chuoiCN) order by  a.ngaythuchi desc";
 ...
 FROM thuchikt a left join dinhkhoanthuchi d on a.IDcha=d.ID left join cuahang b on a.loaitk=b.id left join userac c on a.manv= c.MaNV where 1=1  ".$sql_where." and d.ma in ($chuoiCN) order by  a.ngaythuchi desc limit $start,$limit";
 ...
 <li>
 <input type="button" onclick="xuatexel(9)" name="search3" style="height:30px;margin-left:5px;" id="search3" value="Excel Công nợ" />
 </li>
  	</ul> </div>
...
.chonsodong .select_sodong .select_sodong_item button:hover{
	...
	<input type="hidden" name="totalpage" id="totalpage" value="<?php echo $totalpage; ?>" />
	 ...
	 <div>
	 <button tabindex="1" onclick="changetab(event,'tabletab')">Công nợ nhân viên</button>
	 <button tabindex="2" onclick="changetab(event,'tabletab')">Công nợ sếp</button></div>
<div style="" id="showtb"  >
 
  <div class="tabletab" tabindex="1" style="width:100%;position: -webkit-sticky;
  ...
  <table   border="0" cellpadding="0" cellspacing="0" class="tbchuan table_bc" id="dopcccc" style="width:100%">
  	 ...
  	 <tr align="center" bgcolor="#F8E4CB" class="fixed-top1">
		  ...
		  <th width="37" valign="middle"  ><strong>Ngày Thu Chi </strong></th>
			<th width="37" valign="middle"  ><strong>Tên NV </strong></th>
		   <th width="37" valign="middle"  ><strong>MÃ NV</strong></th>
		  <th width="38" valign="middle" ><strong>Nội dung</strong></th>
			
		  <th width="67" valign="middle" ><strong>Nợ</strong></th>
		  <th width="58" valign="middle" ><strong> Có</strong></th>
		  <th width="35" valign="middle" ><strong>CN Tại cửa hàng</strong></th>
		  <th width="30" valign="middle"  ><strong>Số tiền</strong></th>
		  <th width="33" valign="middle"  ><strong>Ghi chú</strong></th>
	 ...
	 while($re=$data->fetch_array($result)){
		 ...
		 if($re["madk"]=="CNS"){
		 	...
		 	array_push($mangCNsep,$re);
				...
				?>
		<tr align="center" style="background-color:<?php echo $mau;?>">
	 	
		  <td valign="middle"  ><strong><?php echo $re["ngaythuchikt"];?></strong></td>
		  <td valign="middle"  ><strong><?php echo $re["tennhanvien"];?></strong></td>
		    <td valign="middle"  ><strong><?php echo $re["MaNV"];?></strong></td>
			  <td valign="middle"  ><strong><?php echo $re["note"];?></strong></td>
			 <td valign="middle"  ><strong><?php echo $mangtk[$re["tkno"]];?></strong></td>
			 <td valign="middle"  ><strong><?php echo $mangtk[$re["tkco"]];?></strong></td>
			  <td valign="middle"  ><strong><?php echo $re["tencuahang"];?></strong></td>
			   <td valign="middle"  ><strong><?php echo $re["psno"]?number_format($re["psno"]):number_format($re["psco"]);?></strong></td>
			    <td valign="middle"  </td>
	 </tr>
  ...
  <div class="tabletab" tabindex="2" style="width:100%;display:none;position: -webkit-sticky;
	  position: sticky;left:0;z-index:1;">
  ...
  <table  border="0" cellpadding="0" cellspacing="0" class="tbchuan table_bc " id="dopcccc" style="width:100%;">
	 ...
	 <?php
	 	if(count($mangCNsep)){
		  ...
		  <td valign="middle"  ><strong><?php echo $value["ngaythuchikt"];?></strong></td>
		 
			  <td valign="middle"  ><strong><?php echo $value["note"];?></strong></td>
			 <td valign="middle"  ><strong><?php echo $mangtk[$value["tkno"]];?></strong></td>
			 <td valign="middle"  ><strong><?php echo $mangtk[$value["tkco"]];?></strong></td>
			  <td valign="middle"  ><strong><?php echo $value["tencuahang"];?></strong></td>
			   <td valign="middle"  ><strong><?php echo $value["psno"]?number_format($value["psno"]):number_format($value["psco"]);?></strong></td>
			    <td valign="middle"  </td>
	 </tr>
