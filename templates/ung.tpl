...
<fieldset  class="nencon" style="padding:5;margin:0">
	...
	<label style="Color:#FF3300;Font-Weight:Bold;Font-size:9pt;" >Ứng lương</label>
	</a></legend>
...
<!-- BEGIN: block_khht1 --><form name="frmProduct1"  id="frmProduct1"  method="post" style="padding:0;margin:0">
	<table width="100%" border="0" cellpadding="0" class="tbchuan" cellspacing="0">		
 		<tr>
			<td colspan = "8">
				[ <a href="?act=ung&id=-1">Thêm Mới</a>]&nbsp;&nbsp;[<a href="?act=md">Đóng Lại</a>]&nbsp;&nbsp;Tên 
...
<!-- BEGIN: block_khht -->	
				...
				<td align="center"  > 
				<a href = "?act=ung&id={ID}"> <img src = "images/book_addressHS.png" border = "0" ></a> </td>


				<td  align="center">  <a onclick='return ask()' href="?act=ung&Del={ID}"><img src="images/delete.gif" border = "0"></a></td>								
				</tr>
<!-- End: block_khht -->	

<!-- BEGIN: block_khht2 -->	
<tr style="padding-top:10"><td align="right" colspan="5"><strong>Tổng cộng :</strong></td><td> <strong>{tongung}</strong></td><td></td><td></td> </tr>
...
<img src="images/img.gif" id="Lichtungaytao" style="cursor: pointer; border: 0px solid red;" title="Date selector"  onclick="displayCalendar(frmkho.ngay,'dd/mm/yyyy',this)" /> </td>
</tr>
<tr>
	<td colspan="2">
		<input type="Submit" class="text" name="btnUpdate" onclick="return kiemtra()"  value="Cập nhập"> <input type="button" onclick="nhay('ung')" class="text" name="cancel" value="Quay Lại" />	</td>
</tr>
</table>	
</form>
</div>
