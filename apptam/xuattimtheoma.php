...
$data->access();
  ...
  $tmp = explode('*@!',$data1);
	  ...
	  // and c.ngaybatdau<= '$ngaytao' and c.ngayketthuc >= '$ngaytao' and b.IDcuahang= '$kho'
		$sql = " SELECT a.ID,a.Name,a.NameN, b.SoLuong,  a.NameEN,a.codepro,a.code,a.price ,a.giamgia,a.giachan,c.giamgia as giam,a.giabinhquan,c.ghichu as ghichuhh";
...
//		$result = $data->query($sql);
 //echo $sql ;
     ...
     $re = $data->fetch_array($result);
	  if(laso($re['ID'])==0)  { echo "##-1##Không tìm thấy sản phẩm!##";return ; }
 ...
 $ma = stripslashes($re['codepro']) ;
		 ...
		 $dvt = $re['DV'] ;
		  ...
		  if ($gia =='0.00') $gia = "";
		   ...
		   echo "##".  $re['ID'] ."##". $ten ."##". $ma ."##".$gia ."##". $dvt."##". $giamgia."##". $re['ghichuhh']."##". $baohanh."##". $re['SoLuong'] ."##".formatso($re['giachan']) ."##".formatso($re['giabinhquan']) ."##$re[NameN]##"."##$re[ghichu]##";
