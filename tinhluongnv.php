...
function tinhluong_nangluc ($luongvitri, $luongnangluc, $phucap, $congchuanthang, $congthucte) {
	$tienluong = (($luongvitri+$luongnangluc+$phucap)/$congchuanthang)*$congthucte;
	return $tienluong;
}

function tinhluong_doanhthu ($luongcoban,$luongdoanhthu,$phucap,$congchuanthang,$congthucte){
	$tienluong = (($luongcoban+$luongdoanhthu+$phucap)/$congchuanthang)*$congthucte;
	return $tienluong;
}
