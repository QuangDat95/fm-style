...
$data->access();
 ...
 //==================mang tang ca ============================================				
		...
		$sql3="select * from  thongtinluongnv";
    	$result = $data->query($sql3);	 
		$mangthongtinluong='';
		while ($rec = $data->fetch_array($result)  )	 
		{   	
		   $mangthongtinluong[$rec['IDnhanvien']]=array('luongcoban'=>$rec['luongcoban'],
		   											"luongkpi"=>$rec['luongkpi'],
				...
				<?php
					...
					if($idch==62 && $chucvugoc!=977 && $chucvugoc!=872 && $chucvugoc!=763 && $chucvugoc!=740 && $chucvugoc!=876 && $chucvugoc!=742 && $chucvugoc!=779){
						...
						if($mangthongtinluong[$idnv]["luongcoban"]){
							...
							$luongtinh= luongVP($luongcoban,$luongkpi,$luongkpidoanhthu,$doanhthumuctieu,$doanhthuthuc);	
							$tilehoanthanhdoanhthu=$luongtinh["tilehoanthanhdoanhthu"];
							$hesoluongkpidoanhthu=$luongtinh["hesoluongkpidoanhthu"];
							...
							switch($chucvugoc){
								...
								case 681:
									if($mangthongtinluong[$idnv]["luongcoban"]){
										...
										$luongtinh=  luongCVTN($luongcoban,$doanhthucalamviec,$hesodoanhthu,$doanhthucanhan);						$hesoluongdt=$luongtinh["heso"];
										$luongdoanhthu=$luongtinh["luongdoanhthu"];
										$luongthuclanh=$luongtinh["luong"];
										//var_dump($luongthuclanh);
										if($chucvugoc==681){
								...
								if($mangthongtinluong[$idnv]["luongcoban"]){
										...
										$hesodoanhthu=0.2;
										$luongtinh=  luongTDKH($luongcoban,$doanhthucalamviec,$hesodoanhthu,$luongkpi);								$luongdoanhthu=$luongtinh["luongdoanhthu"];
										$luongthuclanh=$luongtinh["luong"];
										//var_dump($luongthuclanh);
