...
<fieldset  class="nencon">
 ...
 <!-- BEGIN: block_cusht1 -->
			...
			<b style="display:{q_them}">	[<a href="?act=themnghiviec&id=-1">Thêm Mới</a>]</b>&nbsp;&nbsp;&nbsp;[<a href="?act=md">Đóng Lại</a>] &nbsp;
...
<div>
    ...
    <tr bgcolor="#F8E4CB">
	  ...
	  <td width="114" align="center"><strong>Tên NV </strong></td>
	   ...
	   <td width="150" align="center"><strong>ngày nghỉ đề xuất</strong></td> 
	    <td width="150" align="center"><strong>ngày nghỉ duyệt</strong></td> 
		 <td width="150" align="center"><strong>ngày nghỉ thực</strong></td> 
		<td width="228" align="center"><strong>Lý do kế toán</strong></td> 
		<td width="78" align="center"><strong>Lý do nhân sự</strong></td> 
...
<td ><strong>{tennhanvien}</strong> <br /> {chucvu} </td>
 ...
 <td style="    max-width: 200px;
    word-break: break-word;">{ngaynghidexuat}</td> 
<td style="    max-width: 200px;
    word-break: break-word;">{ngaynghiduyet}</td> 
	<td style="    max-width: 200px;
    word-break: break-word;">{ngaynghithuc}</td> 
 <td style="    max-width: 200px;
    word-break: break-word;">{lydoketoan}</td>
 <td style="    max-width: 200px;
    word-break: break-word;">{lydogiamdoc}</td>
 <td align="center"   > <a href = "?act=themnghiviec&id={ID}"><img src = "images/book_addressHS.png" border = "0" ></a> </td>
 <td align="center">  <a onclick='return ask()' href="?act=themnghiviec&Del={XOA}"><img src="images/delete.gif" border = "0"></a></td>								
 </tr>
<!-- End: block_cusht -->	

<!-- BEGIN: block_cusht2 -->	
	<tr style="padding-top:10">
	  <td align="right" colspan="16"> {list_page}</td>
	</tr>
	</table>
...
<tr>
	<td width="14%"><strong>Ngày nghỉ đề xuất</strong></td>
	<td width="49%"> 
		<input type="date" onkeyup ="" onblur="" id="ngaynghidexuat" name="ngaynghidexuat" value="{ngaynghidexuat}" required/>
		<strong>Ngày nghỉ được duyệt</strong> 
		<input type="date" onkeyup ="" onblur="" id="ngaynghiduyet" name="ngaynghiduyet" value="{ngaynghiduyet}" disabled="disabled"/>
...
<tr>
	<td width="14%"><strong>Ngày nghỉ thực</strong></td>
	<td width="49%"> 
		
		<input type="date" onkeyup ="" onblur="" id="ngaynghithuc" name="ngaynghithuc" value="{ngaynghithuc}" disabled="disabled"/>
		        </td>
		<td width="35%" >&nbsp;</td>
	<td width="1%" >&nbsp;</td>
	<td width="1%" >&nbsp;</td>
...
<tr>
	<td height="34" colspan="5">
		<input type="Submit" onfocus="setrong()" onclick="return kiemtra()" class="text" name="btnUpdate" id="btnUpdate" value="Cập nhập">
		 <input type="button" onclick="history.back()" class="text" name="cancel" id="cancel" value="Quay Lại" /> 
...
location.replace("?act=themnghiviec");
</script>
<!-- END: block_cusupdate -->
...
(setMintoday)();
		function setMintoday(){
				...
				document.getElementById("ngaynghidexuat").setAttribute('min', today);
