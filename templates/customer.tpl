...
<fieldset  class="nencon">
	...
	<label style="Color:#FF3300;Font-Weight:Bold;Font-size:15pt;" >Danh Sách Khách Hàng</label>
	</a></legend>
   <div    > 
...
<form name="xuatketqua" id="xuatketqua" action="xuatfile.php" method="post" target="_blank" >
 ...
 <div >
 				<b style="display:{q_them}"> [ <a href="default.php?act=customer&id=-1">Thêm Mới</a>]&nbsp;&nbsp;</b>[<a href="default.php?act=md">Đóng Lại</a>]&nbsp;
				<div style="padding:5px"> 
              
 
  <input type="text" name="ma" onkeyup="goikh(this.value)" placeholder="Mã KH_" ondblclick="this.value=''" id="ma" class="inpl"  style="width:55px" onkeypress="return chuyentieps(event,'kv')"   value="" />
 &nbsp; 
...
<input type="hidden" name="mc" ondblclick="this.value=''" id="cm" class="inpl"  style="width:80px" onkeypress="return chuyentieps(event,'kv')"   value="" />
 ...
 <select onkeypress="return chuyentiep(event,'idnhan')" class="js-ch"  name="cuahang"  id="cuahang"  style="width:120px" title="cửa hàng">
  {tatca}
  	{cuahangnhan}
  </select>
   <select onkeypress="return chuyentiep(event,'idnhan')" name="tinh"  id="tinh"  style="width:78px">
...
<img src="images/img.gif" id="Lichtungaytao2" style="cursor: pointer; border: 0px solid red;" title="Date selector"  onclick="displayCalendar(frmProduct1.tungay,'dd/mm/yyyy',this)" />đến<input onkeypress="return chuyentiep(event,'denngay')" title="Click đôi để xoá trắng"  ondblclick="xoatrang(this)" type="text" name="denngay"   id="denngay" class="text" style="width:65px"  value="{denngay}" /><img src="images/img.gif" id="Lichtungaytao2" style="cursor: pointer; border: 0px solid red;" title="Date selector"  onclick="displayCalendar(frmProduct1.denngay,'dd/mm/yyyy',this)" />&nbsp; 
 ...
 <input type="button"   style="width:37px"  onclick="timkiemkh(ten.value,dt.value,ma.value,cuahang.value,cm.value,'',sapxep.value ,tungay.value,denngay.value,tinh.value,trendiem.value)"   name="search5"  id="search5" value="Tìm" />
       
                  <input type="button"   style="width:30px"  onclick="timthongke(ten.value,dt.value,ma.value,cuahang.value,cm.value,'',sapxep.value ,tungay.value,denngay.value,tinh.value)"   name="search2"  id="search2" value="TK"  title="Thống kê số lượng khách theo cửa hàng"/>
     &nbsp;    
		   <input type="button"   style="width:56px"  onclick="timthongkediem(ten.value,dt.value,ma.value,cuahang.value,cm.value,'',sapxep.value ,tungay.value,denngay.value,tinh.value,trendiem.value)"   name="search"  id="search" value="TK điểm" />
		   
                  <input type="button" style="  width: 40px;" id="xuat" value="Excel" name="xuat" onclick="xuatkq()" />
		  </div>
 </div>
	<div id="hienthinhacc"  >
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">		
 		<tr bgcolor="#F8E4CB">
		  ...
		  <td width="153" align="center" class="cothienthi"><strong><strong>Số xe</strong></strong></td> 
...
<tr>
	...
	<td  >
		...
		<select onkeypress="return chuyentieps(event,'Name')" name="nhomkh"  id="nhomkh"  >
		 ...
		 <td><input type="Text" name="makh" id="makh"  class="text" size="8" value="{makh}" autocomplete="off"   onkeypress="return chuyentiep(event,'Name')"/></td>
</tr>
 <tr>
	<td width="17%">
		Tên Khách </td>
	<td colspan="3"><input type="Text" name="Name" id="Name"  class="text" style="width:415px" value="{Name}" onkeypress="return chuyentiep(event,'ngaysinh')"/>
	  <span style="color:#FF0000">*</span></td>
</tr>
<tr>
	<td width="17%">Ngày Sinh </td>
	<td  ><input type="text" name="ngaysinh" id="ngaysinh" onblur="checkDate(this.value)" class="text" size="12" value="{ngaysinh}"  onkeypress="return chuyentiep(event,'xungho')"/>
      <img src="images/img.gif" id="Lichtungaytao" style="cursor: pointer; border: 0px solid red;" title="Date selector"  onclick="displayCalendar(frmProduct2.ngaysinh,'dd/mm/yyyy',this)" /><span style="color:#FF0000">*</span></td>
...
<tr>
	...
	<td width="44%"  ><input type="Text" name="tel" id="tel"  autocomplete="off"   class="text" size="20" value="{tel}" onblur="kiemtradung(this.value)"  onkeydown="onlyintc(this)"  onkeypress="return chuyentiep(event,'IDKhuVuc')"/>
	  <span style="color:#FF0000">*</span></td>
...
<tr>
	<td width="17%">Địa chỉ </td>
		<td width="44%"  ><span style="padding-bottom:10px">
		  <input type="text" id="address"  name="address" class="text" style="width:515px" value="{address}" onkeypress="return chuyentiep(event,'tel')"/>
		  <span style="color:#FF0000"> </span></span></td>
	...
	<td width="17%">Tỉnh Thành</td>
		<td width="44%"  > 
		  ...
		  <select class="js-tinh"  id="IDKhuVuc" name="IDKhuVuc"   style="width:200px">
		   ...
		   <select class="js-quan" name="quan" id="quan" disabled="disabled"  style="width:200px">
		   {quan}
           </select></td>
...
<tr>
	<td width="17%">Phường xã </td>
		<td width="44%"  ><select class="js-phuong" name="phuong" id="phuong" disabled="disabled" style="width:200px">
...
<tr>
  <td>Điểm Tích lũy </td>
  <td  ><input type="text" name="diemtichluy" id="diemtichluy"   class="text" size="10" value="{diemtichluy}"  onkeypress="return chuyentiep(event,'nganhang')"  /></td> 
  <td align="right">Số tiền đã mua </td>
  <td><input type="text" name="sotiendamua" id="sotiendamua" readonly=""  class="text" size="15" value="{sotiendamua}" onkeypress="return chuyentiep(event,'nganhang')" /></td>
</tr>


<tr>
	<td >Chi chú </td>
	<td colspan="3"><textarea id="note" name="note"   class="texta" style='width:650px;height:70px'>{note}</textarea></td>
</tr>
</table>
<br />
	...
	<div style="padding-left:105px;padding-bottom:8px">
	  ...
	  <input type="button" onclick="quaylai()"  name="cancel2" style="width:200px" value="Quay lại danh sách khách hàng" /> 

	  
	   <input type="button" name="inan2" id="inan2"   onclick="window.close()" value="Đóng Lại" style="width:80px;display:{donglai}"/>
      </div>
</fieldset>
