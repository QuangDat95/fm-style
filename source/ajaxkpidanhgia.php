...
$toi= 24-$thang ;
		...
		for ($i=0;$i<=$toi;$i++)
		{ 
 		   $thang=$thang-1 ; if ($thang<=0)  {$thang=$thang+12 ; $nam=$nam-1 ;}   
		   $thangnamv= $nam.'-0'.$thang.'-01'  ; if ($thangnam==$thang.$nam ) $sele = "selected" ;else   $sele = "" ;
...
//=========================================================
	...
	{ 
		...
		else		
		{
			...
			$thang= gmdate('m', time() + 7*3600)+1 ;$nam=gmdate('Y', time() + 7*3600) ;	 
			$toi= 24-$thang ;
 	  		  $chuoi ='';  
			for ($i=0;$i<=$toi;$i++)
			{ 
