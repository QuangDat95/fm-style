		...
		/* echo $loaigiotam."<br>";
		 ...
		 echo $giobatdau1."<br>";
		  echo $giobatdau2."<br>";
		   echo $gioketthuc1."<br>";
		    echo $gioketthuc2."<br>";*/
		 	if($giobatdau1 !=0 && $giobatdau2!=0 && $gioketthuc1!=0 && $gioketthuc2!=0  && $thumay!='Sun'){
		//echo $thumay;
				if($loaigiotam==2 ){
		  ...
		  <td align="right"> <?php echo $r ;?> </td>		
				...
				<td ><strong><?php echo $sogio."h".$sophut ."'"  ; ?></strong></td>
                   <?php for ($i=(int)($ngaybatdau);$i<=(int)($ngaycuoi);$i++){
					  ...
					  ?>
                 <td align="center" bgcolor="<?php echo $maugiolam ; ?>" title="<?=$title?>"><?php echo  $giolam  ;  ?><br /><span style="font-size:10px"><?=$giochunhat?></span></td>
              <?php  } ?>
			  ...
			  <td   align="center" ><?php echo $sogio."h" .$sophut ."'";?></td>    
				...
				<td   align="center" ><?=$giochunhat.'h'.$phutchunhat?></td>    
					...
					<td   align="center" ><input type="text" name="ghichu1" id="ghich1" /></td>    
    </tr>
<?php	
 $r++;
 }
