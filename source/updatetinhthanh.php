...
$template->assign(
    "khuvuc",
    composx("tinh", "Name", $_REQUEST["IDKhuVuc"], "", "")
);
...
if ($_POST["btnUpdate"] != "") {
    ...
    $ngaydaydon = date("Y-n-d H:i:s");	
		...
		if($ID){
			$sql = "UPDATE vanchuyenonline set sobill='$sobill', mavd='$mavd', diachi='$diachi', phitravc='$phiship', tinh='$tinh', quan='$quan', phuong='$phuong', ngaydaydon_dvvc='$ngaydaydon',IDbill='$IDbill',madh='$madh' where ID='$ID'";
            // echo $sql; return;
		}else{
			$sql = "insert into vanchuyenonline set sobill='$sobill', mavd='$mavd', diachi='$diachi', phitravc='$phiship',trigiadon='$trigiadon', tinh='$tinh', quan='$quan', phuong='$phuong',IDbill='$IDbill', ngaydaydon_dvvc='$ngaydaydon',madh='$madh'";
            //  echo $sql; return;
		}
