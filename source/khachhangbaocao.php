...
{ 	
		...
		{ $tudo= " and   IDCuaHang ='$IDCuaHang' "; $diemtichluy =  "" ; $ma='';}
		  $sql = "UPDATE  customer SET   nhomkh='$nhomkh' $ma, IDKhuVuc='$IDKhuVuc', nganhang='$nganhang',  Name ='$Name',address ='$address',type ='$type',tel ='$tel',mobile ='$mobile',Fax ='$Fax',email ='$email',website ='$website',note ='$note',MST ='$MST',STK ='$STK', NameN= '$NameN', addressN = '$addressN' ,xungho='$xungho',cmnd='$cmnd',ngaysinh='$ngaysinh',ngaycapnhap='$ngaytao' ,IDcapnhap ='$IDTao'  $diemtichluy   where ID='0$ID' $tudo " ;		
  ...
  
{
	...
	{    
		...
		$template->assign("khuvuc",composx("tinh","Name",$_REQUEST["kv"],"Rank"));
	...
	{ 
		...
		else		
		{
			...
			$result = $data->fetch_array($query);
				...
				$template->assign("khuvuc",composx("tinh","Name",$result["IDKhuVuc"],"Rank"));
