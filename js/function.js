...
function thongbaomoi(noidung,tieude,mh) 
{
	 if (tieude === undefined) tieude = "* Th�ng b�o";
	 if (mh === undefined) {} else 
	 {      document.getElementById('bangthongbao2').className = "mh" +mh ;
  	        document.getElementById('bangthongbao1').className= "mh" +mh ;
	  }
	 
   if(tieude!='') 	document.getElementById('tbtieude').innerHTML=tieude  ;
      document.getElementById('tbnoidung').innerHTML=noidung  ; 
...
function onlyinthc(txt){ 
 ...
 function onlyintc(txt){ 
	...
	if(event.keyCode==  189  && str=='' )  {  event.returnValue = true;  return ; } 
...
function txtFormata(txt)
{
    ...
    var dautru='';
    if(str[0]=='-')	{   dautru='-'; str= str.substring(1,str.length); }
