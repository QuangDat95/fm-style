...
$data->access();
  ...
  $tmp = explode('*@!',$data1);
		...
		$sql = $sql . " from products  a left join hanghoacuahang b  on (a.ID = b.IDSP )   left join giamgiacuahang c on (c.IDSP = a.ID and  c.IDcuahang =$kho  and c.ngaybatdau<= '$ngaytao' and c.ngayketthuc >= '$ngaytao'  )		
		  where a.codepro = '$macode'  and b.IDcuahang= '$kho'  " ;	
